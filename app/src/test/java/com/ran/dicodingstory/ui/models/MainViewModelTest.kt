...
import com.ran.dicodingstory.DataDummy
import com.ran.dicodingstory.MainDispatcherRule
...
import com.ran.dicodingstory.getOrAwaitValue
...
class MainViewModelTest{
    ...
    fun `when Get Story Should Not Null and Return Data`() = runTest {
        ...
        val actualStory: PagingData<StoryResponseItem> = mainViewModel.getStoriesPaging().getOrAwaitValue()
    ...
    fun `when Get Story Empty Should Return No Data`() = runTest {
        ...
        val mainViewModel = MainViewModel(storyRepository)
        val actualQuote: PagingData<StoryResponseItem> = mainViewModel.getStoriesPaging().getOrAwaitValue()
        val differ = AsyncPagingDataDiffer(
            diffCallback = StoryAdapter.DIFF_CALLBACK,
            updateCallback = noopListUpdateCallback,
            workerDispatcher = Dispatchers.Main,
